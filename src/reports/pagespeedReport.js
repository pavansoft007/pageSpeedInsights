...
const REPORT_COLUMNS = [
  ...
  { header: 'FCP Mobile (Lab)', key: 'fcpMobile', width: 16 },
  { header: 'FCP Desktop (Lab)', key: 'fcpDesktop', width: 16 },
  { header: 'LCP Mobile (Lab)', key: 'lcpMobile', width: 16 },
  { header: 'LCP Desktop (Lab)', key: 'lcpDesktop', width: 16 },
  { header: 'INP Mobile (Lab)', key: 'inpMobile', width: 16 },
  { header: 'INP Desktop (Lab)', key: 'inpDesktop', width: 16 },
  { header: 'CLS Mobile (Lab)', key: 'clsMobile', width: 16 },
  { header: 'CLS Desktop (Lab)', key: 'clsDesktop', width: 16 },
  { header: 'Field LCP Mobile (CrUX)', key: 'fieldLcpMobile', width: 22 },
  { header: 'Field LCP Desktop (CrUX)', key: 'fieldLcpDesktop', width: 22 },
  { header: 'Field INP Mobile (CrUX)', key: 'fieldInpMobile', width: 22 },
  { header: 'Field INP Desktop (CrUX)', key: 'fieldInpDesktop', width: 22 },
  { header: 'Field CLS Mobile (CrUX)', key: 'fieldClsMobile', width: 22 },
  { header: 'Field CLS Desktop (CrUX)', key: 'fieldClsDesktop', width: 22 },
  { header: 'Field CWV Mobile', key: 'fieldCwvMobile', width: 18 },
  { header: 'Field CWV Desktop', key: 'fieldCwvDesktop', width: 18 },
